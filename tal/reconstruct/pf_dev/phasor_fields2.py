...
def backproject_pf_multi_frequency(
        ...
        skip_H_fft=False,
        imaginary_illumination_xyz=None,
        progress=False):

    assert imaginary_illumination_xyz is not None and len(
        imaginary_illumination_xyz) == 3, 'imaginary_illumination_xyz must be a 3D point'
    ...
    d_i = distance(volume_xyz, imaginary_illumination_xyz.reshape(
        (1, 1, 1, 3))).reshape((1, nv, 1))
